...
# Define paths
CSV_OUTPUT="logs/intra_results_perf/viz_intra_frames_${CURRENT_SEQ}.csv"

echo "=================================================="
echo "Job ID: $SLURM_JOB_ID, Task ID: $SLURM_ARRAY_TASK_ID"
echo "Processing Intra-Sequence (PERF): $CURRENT_SEQ"
...
mkdir -p logs/intra_results_perf
